...
while True:
    ...
    if OPCODE == 1:
        ...
        pos = a[i+3]
        a[pos] = output
        print(str(output) + ' placed in spot ' + str(pos))
    elif OPCODE == 2:
        op1pos = a[i+1]
        op2pos = a[i+2]
        output = a[op1pos] * a[op2pos]
